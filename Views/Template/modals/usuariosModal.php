        ...
        <form id="frmUsuarios" method="POST">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control valid validText" id="txtNombre" name="txtNombre" autocomplete="off" required="">
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input type="number" class="form-control valid validNumber" id="txtNumero" name="txtNumero" autocomplete="off" required="">
              </div>
            </div>
